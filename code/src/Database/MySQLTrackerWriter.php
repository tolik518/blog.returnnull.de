...
class MySQLTrackerWriter
{
    ...
    public function write(TrackedUser $trackedUser)
    {
        $sql = $this->mySQLConnector->prepare('INSERT INTO Tracker (ip, visitedtime, url, requestprotocol, redirectstatus, useragent, refferer) 
        ...
        $sql->bindValue(':refferer',        $trackedUser->getRefferer());
        $sql->execute();
    }
}